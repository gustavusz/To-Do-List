...
?>
    <!-- Formulário para editar um Todo -->
    <form method="GET" action="../php/edit.php">
        ...
        <div class="row">
            ...
            <div class="input-field">
                <label for="text">Edite seu To-do:</label>
                <!-- Caixa de texto para mostrar o Todo a ser editado. -->
                <input type="text" name="text" id="text" value="<?php echo $todo['content']; ?>" class="col s11">
            </div>

            <!-- Botão para enviar o formulario. -->
            <button type="submit"class="btn btn-floating green">
