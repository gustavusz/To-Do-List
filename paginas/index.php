...
?>
    ...
    <div class="row">
        ...
        <a href="editTodo.php?id=<?php echo $todo['id']; ?>" class="btn green"><i class="material-icons">edit</i></a>

        <!-- Link para remover um todo, passando o ID pela URL -->
        <a href="removeTodo.php?id=<?php echo $todo['id']; ?>" class="btn red"><i class="material-icons">delete</i></a>
...
?>
    ...
    <div class="row">
        ...
        <a href="addTodo.php" class="col s12 btn blue">Adicionar</a>
    </div>
